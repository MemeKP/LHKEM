    ...
    <footer className="bg-white border-t border-gray-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div className="flex flex-col">
                <span className="text-base font-extrabold text-gray-900">The Community Platform</span>
                <span className="text-sm font-semibold text-gray-600">The Community</span>
              </div>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-gray-900 font-extrabold mb-4">{ct('ลิงก์ด่วน', 'Quick Links')}</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-700 font-semibold hover:text-gray-900 text-base transition-colors inline-block">
                  {ct('หน้ารวมชุมชน', 'Community Home')}
                </Link>
              </li>
              <li>
                <Link to="/login" className="text-gray-700 font-semibold hover:text-gray-900 text-base transition-colors inline-block">
                  {t('nav.login')}
                </Link>
              </li>
              <li>
                <Link to="/register" className="text-gray-700 font-semibold hover:text-gray-900 text-base transition-colors inline-block">
                  {t('nav.register')}
                </Link>
              </li>
            </ul>
          ...
          {/* About */}
          <div>
            <h3 className="text-gray-900 font-extrabold mb-4">{ct('เกี่ยวกับ', 'About')}</h3>
            <p className="text-gray-700 font-semibold text-base leading-relaxed">
              {ct(
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 text-center">
          <p className="text-gray-600 font-semibold text-base">
            © {new Date().getFullYear()} The Community Platform. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
