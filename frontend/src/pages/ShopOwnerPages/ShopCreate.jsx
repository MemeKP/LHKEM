    ...
    <div className="min-h-screen bg-[#F5EFE7] py-12 animate-fadeIn">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 animate-fadeIn">
          <h1 className="text-4xl md:text-5xl font-extrabold text-[#2F4F2F] mb-3">สร้างโปรไฟล์ร้านของคุณ</h1>
          <p className="text-[#6B6B6B] text-lg font-bold">กรอกข้อมูลร้านของคุณเพื่อเริ่มต้นใช้งาน</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm p-8 space-y-6 border border-gray-100 animate-slideUp" style={{animationDelay: '0.1s'}}>
          ...
          <div className="animate-fadeIn" style={{animationDelay: '0.4s'}}>
            ...
            />
            <p className="text-sm font-bold text-[#9CA3AF] mt-1">ไม่ต้องยาวมากก็ได้ แค่ให้ลูกค้ารู้จักร้านของคุณ</p>
          </div>

          {/* ชุมชน */}
          <div className="animate-fadeIn" style={{animationDelay: '0.45s'}}>
            <label className="block text-lg font-bold text-[#3D3D3D] mb-2">เลือกชุมชน</label>
            <select
              name="community"
              value={communityId}
            ...
            <p className="text-sm font-bold text-[#9CA3AF] mt-1">เลือกร้านสังกัดชุมชนในระบบ</p>
          </div>

          {/* ที่อยู่ */}
          <div className="animate-fadeIn" style={{animationDelay: '0.48s'}}>
            <label className="block text-lg font-bold text-[#3D3D3D] mb-3">📍 ที่อยู่ร้าน</label>
            <textarea
              name="address"
          ...
          <div className="animate-fadeIn" style={{animationDelay: '0.5s'}}>
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-base font-bold text-[#6B6B6B] mb-1.5">📱 เบอร์โทรศัพท์</label>
              ...
              <div>
                <label className="block text-base font-bold text-[#6B6B6B] mb-1.5">💬 LINE ID</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-base font-bold text-[#6B6B6B] mb-1.5">📘 ชื่อ Facebook</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <div className="flex items-center justify-between mt-1">
                  <p className="text-base font-bold text-[#9CA3AF]">เวลาเปิด (ปล่อยว่างหากไม่แน่นอน)</p>
                  {shopData.openTime && (
                    <button
                      type="button"
          ...
          <div className="pt-4 animate-fadeIn" style={{animationDelay: '0.8s'}}>
            ...
            <p className="text-center text-sm font-bold text-[#6B6B6B] mt-3">ข้อมูลจะถูกบันทึกและแสดงในหน้าร้านค้าทันที</p>
          </div>
        </form>
      </div>
      <ShopMapPinModal
