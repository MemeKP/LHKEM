    ...
    <div className="min-h-screen bg-[#F5EFE7] py-8 animate-fadeIn">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 text-center animate-fadeIn">
          <h1 className="text-3xl font-bold text-[#1A1A1A] mb-2">{ct('สร้างกิจกรรมของชุมชน', 'Create Community Event')}</h1>
          <p className="text-[#666666] text-base font-bold">{ct('กรอกข้อมูลกิจกรรมพิเศษหรือเทศกาลของชุมชน', 'Fill in information for special events or community festivals')}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 transition-all duration-300 hover:shadow-xl">
          ...
          <div className="mb-6">
            ...
            />
            <p className="text-sm font-bold text-[#888888] mt-1">{ct('ภาษาไทย', 'Thai')}</p>
          </div>
          ...
          <div className="mb-6">
            ...
            />
            <p className="text-sm font-bold text-[#888888] mt-1">{ct('ใช้สำหรับแสดงผลในภาษาอังกฤษ', 'Used for English interfaces')}</p>
          </div>
          ...
          <div className="mb-6">
            ...
            />
            <p className="text-sm font-bold text-[#888888] mt-1">{ct('ใช้สำหรับผู้ใช้ภาษาอังกฤษ', 'For English-speaking visitors')}</p>
          </div>
